                ...
                <hr/>
                    <form method="post" enctype="multipart/form-data" id="upload_form_of_channel">
                        <div style={inputFieldStyle}>
                            Channel ID:
                             <InputField id="channel_id" name="channel_id" placeholder="Channel Unique ID  Eg: pawan_kalyan, mahesh_babu, salman_khan" />
                        </div>
                        <div style={inputFieldStyle}>
                            Display Name:
                        ...
                        <div onClick={this.handleSubmitChannel} style={submitStyle}>
                            <RedButton  text = "CreateChannel" />
                        </div>
                        <div style={inputFieldStyle} >
